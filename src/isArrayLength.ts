...
type More<TArr extends any[], TLen extends number> = (
  Number.Greater<TLen, MAX_DEPTH> extends 0
    ? TLen extends 0
      ? [TArr[number], ...TArr[number][]]
      : [TArr[number], ...More<TArr, Number.Sub<TLen, 1>>]
    : TArr
);
type Less<TArr extends any[], TLen extends number> = (
  Number.Greater<TLen, MAX_DEPTH> extends 0
    ? TLen extends 1
      ? []
      : [TArr[number], ...Less<TArr, Number.Sub<TLen, 1>>] | Less<TArr, Number.Sub<TLen, 1>>
    : TArr
);
type MoreOrEqual<TArr extends any[], TLen extends number> = (
  Number.Greater<TLen, MAX_DEPTH> extends 0
    ? TLen extends 1
      ? [TArr[number], ...TArr[number][]]
      : [TArr[number], ...MoreOrEqual<TArr, Number.Sub<TLen, 1>>]
    : TArr
);
type LessOrEqual<TArr extends any[], TLen extends number> = (
  Number.Greater<TLen, MAX_DEPTH> extends 0
    ? TLen extends 0
      ? []
      : [TArr[number], ...LessOrEqual<TArr, Number.Sub<TLen, 1>>] | LessOrEqual<TArr, Number.Sub<TLen, 1>>
    : TArr
);
type Equal<TArr extends any[], TLen extends number> = (
  number extends TLen
    ...
    : Number.Greater<TLen, MAX_DEPTH> extends 0
      ? TLen extends 0
        ? []
        : [TArr[number], ...Equal<TArr, Number.Sub<TLen, 1>>]
      : TArr & { length: TLen }
);
